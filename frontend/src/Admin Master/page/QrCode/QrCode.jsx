...
export default function QrCode({ isOpen = false, onClose = () => {}, onSave = () => {} }) {
    ...
    <div className="digital-sign-overlay" role="dialog" aria-modal="true" onClick={onClose}>
          ...
          <div className="upload-area centered">
            ...
            {preview && (
              <div className="thumb-wrap">
                <img className="thumb" src={preview} alt="QR preview" />
      ...
      <ImageEditor
        ...
        onSave={(result) => {
          ...
          setFileName((prev) => (prev ? `cropped-${prev}` : 'cropped-qr.png'));
