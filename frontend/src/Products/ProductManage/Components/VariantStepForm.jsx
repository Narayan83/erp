                  ...
                  <Box display="flex" alignItems="center" gap={1}>
                    <Box
                      sx={{
                        width: 20,
                        height: 20,
                        backgroundColor: colorInfo?.hex || v.color,
                    ...
                    <Box display="flex" gap={0.5}>
                      {v.images.slice(0, 3).map((img, j) => (
                        <Box
                          key={j}
                          component="img"
                          src={typeof img === "string" ? `${BASE_URL}/uploads/${img}` : URL.createObjectURL(img)}
                          alt={`variant-${idx}-img-${j}`}
                          sx={{
                            width: 30,
                            height: 30,
                            objectFit: 'cover',
