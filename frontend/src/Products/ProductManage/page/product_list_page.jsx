...
const ProductTableBody = memo(function ProductTableBody({ products, navigate, loading }) {
...
export default function ProductListPage() {
  ...
  // Debounce filters -> debouncedFilters (API trigger) (shortened)
  useEffect(() => {
      ...
      <Paper>
        <TableContainer sx={{ position: 'relative' }}>
          ...
          <Table size="small">
            ...
            {/* UPDATED: pass loading into body */}
            <ProductTableBody products={products} navigate={navigate} loading={loading} />
          </Table>
        </TableContainer>
        {/* ...existing pagination box... */}
