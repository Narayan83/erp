...
type User struct {
	...
	CountryCode     string      `gorm:"not null" json:"country_code"`
	MobileNumber    string      `gorm:"not null;unique" json:"mobile_number"`
	EmergencyNumber string      `gorm:"not null;unique" json:"emergency_number"`
	AlternateNumber string      `gorm:"not null;unique" json:"alternate_number"`
	WhatsappNumber  string      `gorm:"not null;unique" json:"whatsapp_number"`
	ContactNo       *string     `json:"contact_no,omitempty"`
	Email           string      `gorm:"unique;not null" json:"email"`
	Website         *string     `json:"website,omitempty"`
	BusinessName    *string     `json:"business_name,omitempty"`
